...
function Checkin() {
    ...
    $.log("▶️ 开始签到...");
    if (isSilent) $.log("🔇 当前为静默运行模式 (成功将不弹窗通知)");
        ...
        if (error) {
            ...
            try {
                ...
                if (obj.ret === 1) {
                    ...
                    $.log("⚠️ 签到结果: " + obj.msg);
                    // 如果提示包含“已经签到过了”之类的字眼，也视作成功，受静默规则控制
                    const isAlreadyCheckedIn = obj.msg && obj.msg.indexOf("已经") !== -1;
                    
                    if (!isSilent || !isAlreadyCheckedIn) {
